...
/**
 * Footer Component
 * Premium footer with logo, contact info, quick links, and social media
 * Features gradient accent line and glassmorphism styling
 */
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/as.studios.be?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
      icon: (
    ...
    {
      name: 'TikTok',
      href: 'https://www.tiktok.com/@asagency.be?is_from_webapp=1&sender_device=pc',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <p className="text-sm text-gray-500">
            © {currentYear} as_studio. Tous droits réservés.
          </p>
          <p className="text-sm text-gray-400">
            Crafted with passion in Brussels
          </p>
        </motion.div>
      </div>
    </footer>
